...
models <- list(
    "Spline pH Simple" = spline_simple,
    "Spline pH Weighted" = spline_weighted,
    "Spline pH Hybrid Sampled" = spline_mixed_sampling,
    "Spline pH Hybrid Sampled Weighted" = spline_mixed_weighted
)

# Create a dataframe with the results
class_mse_vectors <- list(
    "Spline pH Simple" = val_results_simple$mse_per_class,
    "Spline pH Weighted" = val_results_weighted$mse_per_class,
    "Spline pH Hybrid Sampled" = val_results_mixed$mse_per_class,
    "Spline pH Hybrid Sampled Weighted" = val_results_mixed_weighted$mse_per_class
)
