...
models <- list(
    "Spline Residual.Sugar Simple" = spline_simple,
    "Spline Residual.Sugar Weighted" = spline_weighted,
    "Spline Residual.Sugar Hybrid Sampled" = spline_mixed_sampling,
    "Spline Residual.Sugar Hybrid Sampled Weighted" = spline_mixed_weighted
)

# Create a dataframe with the results
class_mse_vectors <- list(
    "Spline Residual.Sugar Simple" = val_results_simple$mse_per_class,
    "Spline Residual.Sugar Weighted" = val_results_weighted$mse_per_class,
    "Spline Residual.Sugar Hybrid Sampled" = val_results_mixed$mse_per_class,
    "Spline Residual.Sugar Hybrid Sampled Weighted" = val_results_mixed_weighted$mse_per_class
)
