...
models <- list(
    "Spline Density Simple" = spline_simple,
    "Spline Density Weighted" = spline_weighted,
    "Spline Density Hybrid Sampled" = spline_mixed_sampling,
    "Spline Density Hybrid Sampled Weighted" = spline_mixed_weighted
)

# Create a dataframe with the results
class_mse_vectors <- list(
    "Spline Density Simple" = val_results_simple$mse_per_class,
    "Spline Density Weighted" = val_results_weighted$mse_per_class,
    "Spline Density Hybrid Sampled" = val_results_mixed$mse_per_class,
    "Spline Density Hybrid Sampled Weighted" = val_results_mixed_weighted$mse_per_class
)
